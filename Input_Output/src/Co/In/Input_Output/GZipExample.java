...
public class GZipExample {
	...
	public void gzipMyFile() {
		...
		try {
			...
			GZIPOutputStream gos = new GZIPOutputStream(new FileOutputStream("/home/wr0ngway/Desktop/yogi.gz/"));

			// Specify location of Input file here
			FileInputStream fis = new FileInputStream("/home/wr0ngway/Desktop/yogi.gz/");
